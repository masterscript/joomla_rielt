...
else
{
	...
	?>
	<div class="staff<?php echo $this->pageclass_sfx?><?php echo $direction; ?>">
	...
	<h2 class="<?php echo $direction; ?>">
		...
		<?php endif; ?>
		<a href="<?php echo $this->item->email; ?>" target="_blank">
		<?php echo str_replace('&apos;', "'", $this->item->from_name); ?></a>
	</h2>
...
<?php endif; ?>
	...
	<?php
		...
		$uri = substr($uri, 0, 4) != 'http' ? $this->item->email : $uri;
